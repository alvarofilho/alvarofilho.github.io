...
<main class="command-home">
  <section class="cmd-overview" aria-labelledby="home-title">
    ...
    <article class="cmd-panel cmd-metric">
      ...
      <small>{messages.command.integrationsSystems}</small>
    </article>
    <article class="cmd-panel cmd-metric">
...
<style>
  ...
  .cmd-section{padding:6.5rem 0 0;scroll-margin-top:1rem}.cmd-section-head{display:flex;align-items:end;justify-content:space-between;gap:2rem;margin-bottom:1.5rem}.cmd-section-head>div>span{color:var(--accent);font-size:.58rem;letter-spacing:.12em;text-transform:uppercase}.cmd-section-head h2{margin-top:.45rem;font-family:var(--sans);font-size:clamp(2.2rem,4vw,3rem);line-height:1;letter-spacing:-.055em}.cmd-section-head>a{display:flex;align-items:center;gap:.4rem;color:var(--muted);font-size:.58rem;text-decoration:none;text-transform:uppercase}.cmd-section-head>a:hover{color:var(--accent)}.cmd-status{display:flex;align-items:center;gap:.45rem;color:var(--dimmer);font-size:.55rem}.cmd-status i{width:6px;height:6px;background:var(--accent);border-radius:50%;box-shadow:0 0 10px color-mix(in srgb,var(--accent) 70%,transparent)}
  .cmd-stack-grid{display:grid;grid-template-columns:repeat(4,1fr);border-top:1px solid var(--cmd-line);border-left:1px solid var(--cmd-line)}.cmd-stack-grid article{min-height:180px;padding:1.2rem;background:var(--cmd-panel);border-right:1px solid var(--cmd-line);border-bottom:1px solid var(--cmd-line)}.cmd-stack-grid article>div{display:flex;justify-content:space-between;color:var(--dimmer);font-size:.56rem;text-transform:uppercase}.cmd-stack-grid article>div small{color:var(--accent)}.cmd-stack-grid p{display:flex;flex-wrap:wrap;gap:.4rem;margin-top:3.5rem}.cmd-stack-grid b,.cmd-project footer span,.cmd-experience-tech span{padding:.3rem .5rem;color:var(--muted);background:var(--tag-bg);border:1px solid var(--border);font-size:.54rem;font-weight:400}.cmd-stack-grid b.cmd-soft{color:var(--dimmer)}.cmd-stack-wide{grid-column:span 4;min-height:auto!important}.cmd-stack-wide p{margin-top:1.5rem}
  .cmd-project-grid{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid var(--cmd-line);border-left:1px solid var(--cmd-line)}.cmd-project{display:flex;flex-direction:column;min-height:310px;padding:1.25rem;background:var(--cmd-panel);border-right:1px solid var(--cmd-line);border-bottom:1px solid var(--cmd-line);text-decoration:none}.cmd-project-wide{grid-column:span 2}.cmd-project-top{display:flex;justify-content:space-between;color:var(--dimmer);font-size:.6rem}.cmd-project h3{margin:auto 0 .7rem;color:var(--text);font-family:var(--sans);font-size:1.5rem;line-height:1;letter-spacing:-.04em}.cmd-project p{max-width:600px;color:var(--muted);font-family:var(--sans);font-size:.76rem;line-height:1.55}.cmd-project footer{display:flex;flex-wrap:wrap;gap:.4rem;margin-top:1.2rem;padding:0;border:0}.cmd-project:hover{background:var(--card-h)}.cmd-project:hover h3{color:var(--accent)}
  .cmd-experience-body{display:grid;grid-template-columns:.7fr 1.3fr;gap:4rem;padding:2rem}.cmd-experience-company>span{color:var(--accent);font-size:.56rem}.cmd-experience-company h3{margin:.7rem 0 .35rem;font-family:var(--sans);font-size:2rem;letter-spacing:-.05em}.cmd-experience-company p{color:var(--muted);font-size:.65rem}.cmd-experience-company small{display:flex;align-items:center;gap:.35rem;margin-top:1.2rem;color:var(--dimmer);font-size:.58rem}.cmd-experience ul{display:grid;gap:.8rem;color:var(--muted);font-family:var(--sans);font-size:.83rem;line-height:1.6}.cmd-experience li::marker{color:var(--accent)}.cmd-experience-tech{grid-column:2;display:flex;flex-wrap:wrap;gap:.4rem}
  .cmd-notes{border:1px solid var(--cmd-line)}.cmd-notes-head,.cmd-notes>a{display:grid;grid-template-columns:3rem minmax(260px,1fr) 14rem 8rem 1rem;align-items:center;gap:1rem;padding:.8rem 1rem;border-bottom:1px solid var(--cmd-line);font-size:.6rem}.cmd-notes-head{color:var(--dimmer);background:var(--cmd-panel-head)}.cmd-notes>a{color:var(--text);text-decoration:none}.cmd-notes>a>span,.cmd-notes time{color:var(--muted)}.cmd-note-copy{display:grid;gap:.3rem}.cmd-note-copy strong{font-family:var(--sans);font-size:.82rem}.cmd-note-copy small{color:var(--dimmer);font-family:var(--sans);font-size:.64rem;line-height:1.4}.cmd-note-tags{display:flex;flex-wrap:wrap;gap:.3rem}.cmd-note-tags span{padding:.2rem .35rem;color:var(--muted);background:var(--tag-bg);border:1px solid var(--border);font-size:.5rem}.cmd-note-tags .cmd-note-lang-current{color:var(--accent);border-color:color-mix(in srgb,var(--accent) 45%,var(--border))}.cmd-notes>a:hover{background:var(--card-h)}.cmd-notes>a:hover strong{color:var(--accent)}.cmd-blog-cta{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:1.1rem 1rem;color:var(--text);border:1px solid var(--cmd-line);border-top:0;text-decoration:none}.cmd-blog-cta>span{display:grid;gap:.2rem}.cmd-blog-cta strong{font-size:.7rem}.cmd-blog-cta small{color:var(--dimmer);font-size:.58rem}.cmd-blog-cta:hover{color:var(--accent);background:var(--card-h)}.cmd-empty{padding:2rem}.cmd-empty span{color:var(--accent);font-size:.62rem}.cmd-empty p{margin-top:.6rem;color:var(--muted);font-family:var(--sans)}
  .cmd-contact-section{padding-bottom:8rem}.cmd-contact-grid{display:grid;grid-template-columns:repeat(2,1fr);border-top:1px solid var(--cmd-line);border-left:1px solid var(--cmd-line)}.cmd-contact-grid>a,.cmd-contact-grid>div{display:grid;grid-template-columns:1fr auto;gap:1rem;min-height:145px;padding:1.2rem;color:var(--text);background:var(--cmd-panel);border-right:1px solid var(--cmd-line);border-bottom:1px solid var(--cmd-line);text-decoration:none}.cmd-contact-grid>a>span,.cmd-contact-grid>div>span{display:flex;align-items:center;gap:.45rem;color:var(--accent);font-size:.56rem}.cmd-contact-grid strong{align-self:end;font-family:var(--sans);font-size:1.2rem;letter-spacing:-.03em}.cmd-contact-grid>a>:global(svg:last-child){grid-column:2;grid-row:1 / span 2}.cmd-contact-grid>a:hover{background:var(--card-h)}.cmd-contact-grid>a:hover strong{color:var(--accent)}
